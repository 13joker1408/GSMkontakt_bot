...
async def contacts(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "1. 🏠 <b>Заречье:</b> ул. Максима Горького, д.35а\n"
        "   📞 +7-953-972-66-85\n\n"
        "2. 🏠 <b>Пролетарский:</b> ул. Ложевая, д.125а, ТЦ «ПРОЛЕТАРСКИЙ»\n"
        "   📞 +7-999-775-18-25\n\n"
        "3. 🏠 <b>Центр:</b> ул. Каминского, д.4Б\n"
        "   📞 +7-952-018-54-72\n\n"
        "4. 🏠 <b>Центр:</b> ул. 9-мая д.2, «SPAR»\n"
        "   📞 +7-953-962-53-77\n\n"
        "5. 🏠 <b>Советский:</b> Красноармейский пр-т, д.19, ТЦ «ФАБРИКАНТ»\n"
        "   📞 +7-902-697-88-58\n\n"
        "📞 <b>Телефон горячей линии:</b> 8-800-302-20-71\n\n"
